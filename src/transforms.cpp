// ----------------------------------------------------------------------
// |  Workaround solution until pcl_ros package is available for ROS 2  |
// ---------------------------------------------------------------------
//
...
Eigen::Matrix4f transformAsMatrix(const geometry_msgs::msg::TransformStamped &transform_stamped) {
